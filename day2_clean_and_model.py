...
# Day 2's sign-correction on deal_value never propagated to this copy, so a handful of
# payments retained the original negative sign. Fix by re-deriving amount from the
# cleaned deal_value rather than trusting the stale copy.
